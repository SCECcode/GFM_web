...
function makeRegionsTable() {
   ...
   tbhtml=tbhtml+"<div class=\"gfm-table\"><table><tbody>";
   tbhtml=tbhtml+"<tr><td style=\"width:3px\">ID</td><td style=\"width:18vw\">Region Name</td><td style=\"width:5px\">sliver</td></tr>";
   for( i=0; i<cnt; i++) {
     var item=tb[i];
     var id=item['id']
     var name=item['name'];
     var sliver=item['sliver'];
     var t="<tr><td style=\"width:3px\">"+id+"</td><td style=\"width:18vw\">"+name+"</td><td style=\"width:5px\">"+sliver+"</td></tr>";
     tbhtml=tbhtml+t;
   }
   tbhtml=tbhtml+"</tbody></table></div>";
   return tbhtml;

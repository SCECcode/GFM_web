...
$qstub=" -h 100 -d vs -c cvmh -a d -s 0 -o ../result/cross.png -n ../model/UCVMC_TARGET/conf/ucvm.conf -i ../model/UCVMC_TARGET ";
...
$resultstring = htmlspecialchars($query, ENT_QUOTES, 'UTF-8');
